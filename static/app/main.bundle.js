...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__stores_auth_auth_reducer__ = __webpack_require__("./src/app/stores/auth/auth.reducer.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__app_routing_module__ = __webpack_require__("./src/app/app-routing.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_root_root_component__ = __webpack_require__("./src/app/components/root/root.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__components_sidebar_left_left_component__ = __webpack_require__("./src/app/components/sidebar/left/left.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__components_sidebar_top_top_component__ = __webpack_require__("./src/app/components/sidebar/top/top.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__components_sounds_sounds_component__ = __webpack_require__("./src/app/components/sounds/sounds.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__components_soundplayer_soundplayer_component__ = __webpack_require__("./src/app/components/soundplayer/soundplayer.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__services_api_api_service__ = __webpack_require__("./src/app/services/api/api.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_9__components_root_root_component__["a" /* RootComponent */],
                __WEBPACK_IMPORTED_MODULE_10__components_homepage_homepage_component__["a" /* HomePageComponent */],
                __WEBPACK_IMPORTED_MODULE_14__components_sidebar_left_left_component__["a" /* LeftSideBarComponent */],
                __WEBPACK_IMPORTED_MODULE_15__components_sidebar_top_top_component__["a" /* TopSideBarComponent */],
                ...
                __WEBPACK_IMPORTED_MODULE_17__components_sounds_sounds_component__["a" /* SoundsComponent */],
                __WEBPACK_IMPORTED_MODULE_18__components_soundplayer_soundplayer_component__["a" /* SoundPlayerComponent */],
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_4__ngrx_store__["b" /* StoreModule */].forRoot({
                    auth: __WEBPACK_IMPORTED_MODULE_7__stores_auth_auth_reducer__["a" /* AuthReducer */]
                }),
                __WEBPACK_IMPORTED_MODULE_5_ngx_file_drop__["a" /* FileDropModule */],
                __WEBPACK_IMPORTED_MODULE_6_ng_snotify__["a" /* SnotifyModule */],
            ],
            providers: [
                __WEBPACK_IMPORTED_MODULE_19__services_api_api_service__["a" /* ApiService */],
                { provide: 'SnotifyToastConfig', useValue: __WEBPACK_IMPORTED_MODULE_6_ng_snotify__["c" /* ToastDefaults */] },
                __WEBPACK_IMPORTED_MODULE_6_ng_snotify__["b" /* SnotifyService */]
            ],
            bootstrap: [__WEBPACK_IMPORTED_MODULE_9__components_root_root_component__["a" /* RootComponent */]]
        })
    ], AppModule);
    return AppModule;
}());
...
module.exports = "<div *ngIf=\"auth.isAuth\" class=\"row\">\n  <div class=\"col-md-2\"></div>\n  <div class=\"col-md-8\">\n    <div class=\"py-5 text-center\">\n      <h2>Editer mes informations</h2>\n    </div>\n    <h4 class=\"mb-3\">Informations personnelle</h4>\n    <form #editForm=\"ngForm\" (ngSubmit)=\"editAccount(editForm.value)\" >\n      <div class=\"row\">\n        <div class=\"col-md-6 mb-3\">\n          <label for=\"firstName\">Nom </label>\n          <input name=\"lastName\" type=\"text\" class=\"form-control\" id=\"lastName\" placeholder=\"Dupont\" value=\"\" [(ngModel)]=\"user.lastName\">\n        </div>\n        <div class=\"col-md-6 mb-3\">\n          <label for=\"lastName\">Prénom</label>\n          <input name=\"firstName\" type=\"text\" class=\"form-control\" id=\"firstName\" value=\"\" placeholder=\"Jean\" [(ngModel)]=\"user.firstName\">\n        </div>\n      </div>\n      <hr class=\"mb-4\">\n      <div class=\"mb-3\">\n        <label for=\"artistName\">Nom d'artiste <span class=\"text-muted\"></span></label>\n        <input name=\"artistName\" type=\"text\" class=\"form-control\" id=\"artistName\" placeholder=\"DJ ESGI\" [(ngModel)]=\"user.artistName\">\n      </div>\n      <div class=\"mb-3\">\n        <label for=\"phone\">Numéro de téléphone : </label>\n        <input name=\"phone\" type=\"text\" class=\"form-control\" id=\"phone\" placeholder=\"+33635000007\" [(ngModel)]=\"user.phone\">\n      </div>\n      <hr class=\"mb-4\">\n      <button class=\"btn btn-primary btn-lg btn-block\" type=\"submit\">Editer</button>\n    </form>\n  </div>\n</div>\n"
...
var EditComponent = /** @class */ (function () {
    ...
    EditComponent.prototype.editAccount = function (form) {
        var _this = this;
        var newUser = form;
        this.apiService.editAccount(this.auth.token, newUser).subscribe(function (result) {
            console.log(result);
...
var RootComponent = /** @class */ (function () {
    function RootComponent(store, apiService) {
        this.store = store;
        this.apiService = apiService;
    }
    RootComponent.prototype.loadWebAuth = function () {
        ...
        if (authItem && authItem.isAuth) {
            ...
            sub.subscribe(function (user) {
                _this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_3__stores_auth_auth_actions__["d" /* LoginIn */](user));
            }, function (err) {
                console.log(err);
                _this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_3__stores_auth_auth_actions__["c" /* LogOut */]());
            });
        }
        else {
            this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_3__stores_auth_auth_actions__["c" /* LogOut */]());
...
module.exports = ".player-container{\n  position: relative;\n  margin-bottom: 12px;\n  height: 220px;\n  width: 100%;\n  overflow-x: hidden;\n  background-color: #ffffff;\n}\n\n.player-image{\n  position: absolute;\n  height: 128px;\n  width: 128px;\n  top: 44px;\n  left: 26px;\n  background-image: url(http://localhost:8080/icons/wave.svg);\n  background-size: 100% auto;\n}\n\n.waveform-container{\n  width: 460px;\n  position: absolute;\n  left: 220px;\n  bottom: 26px;\n}\n\n.player-btn{\n  position: absolute;\n  top: 27px;\n  color: #f50;\n  left: 193px;\n  font-size: 48px;\n}\n\n.sound-info{\n  position: absolute;\n  top: 34px;\n  color: #D3D3D3;\n  left: 250px;\n}\n\n.sound-artist{\n  color: #999;\n}\n\n.sound-name{\n  color: #333;\n}\n"
...
module.exports = "\n<ul class=\"nav nav-tabs\" id=\"myTab\" role=\"tablist\">\n  <li (ng-click)=\"loadSounds()\" class=\"nav-item\">\n    <a class=\"nav-link active\" id=\"instu-tab\" data-toggle=\"tab\" href=\"#instru\" role=\"tab\" aria-controls=\"home\" aria-selected=\"true\">\n      Mes instruments\n    </a>\n  </li>\n  <li (ng-click)=\"loadMusics()\" class=\"nav-item\">\n    <a class=\"nav-link\" id=\"music-tab\" data-toggle=\"tab\" href=\"#music\" role=\"tab\" aria-controls=\"profile\" aria-selected=\"false\">\n      Mes musiques\n    </a>\n  </li>\n  <li class=\"nav-item\">\n    <a class=\"nav-link\" id=\"album-tab\" data-toggle=\"tab\" href=\"#album\" role=\"tab\" aria-controls=\"contact\" aria-selected=\"false\">\n      Mes albums\n    </a>\n  </li>\n</ul>\n<div class=\"tab-content\" id=\"myTabContent\">\n  <div class=\"tab-pane fade show active\" id=\"instru\" role=\"tabpanel\" aria-labelledby=\"home-tab\">\n    <div class=\"row\">\n      <div class=\"col-xs-12 col-sm-12 col-md-12\" *ngFor=\"let sound of sounds\">\n        <app-soundplayer [sound]=\"sound\"></app-soundplayer>\n      </div>\n      <div *ngIf=\"!sounds.length\" class=\"col-xs-12 col-sm-12 col-md-12\">\n        <div class=\"empty\">\n          <p>Aucun instrument n'a été déposé</p>\n        </div>\n      </div>\n    </div>\n  </div>\n  <div class=\"tab-pane fade\" id=\"music\" role=\"tabpanel\" aria-labelledby=\"profile-tab\">\n    <div class=\"row\">\n      <div class=\"col-xs-12 col-sm-12 col-md-12\" *ngFor=\"let music of musics\">\n        <app-soundplayer [sound]=\"music\"></app-soundplayer>\n      </div>\n      <div *ngIf=\"!musics.length\" class=\"col-xs-12 col-sm-12 col-md-12\">\n        <div class=\"empty\">\n          <p>Aucune musique instrument n'a été déposé</p>\n        </div>\n      </div>\n    </div>\n  </div>\n  <div class=\"tab-pane fade\" id=\"album\" role=\"tabpanel\" aria-labelledby=\"album\">\n    <div class=\"row\">\n      <div class=\"col-xs-12 col-sm-12 col-md-12\" *ngFor=\"let album of albums\">\n      </div>\n      <div *ngIf=\"!albums.length\" class=\"col-xs-12 col-sm-12 col-md-12\">\n        <div class=\"empty\">\n          <p>Vous n'avez créé aucun album</p>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n"
...
var SoundsComponent = /** @class */ (function () {
    ...
    SoundsComponent.prototype.loadSounds = function () {
        var _this = this;
        console.log("loadSounds");
        this.apiService.getUserSound(this.auth.token).subscribe(function (results) {
    ...
    SoundsComponent.prototype.loadMusics = function () {
        var _this = this;
        console.log("loadMusic");
        this.apiService.getUserMusic(this.auth.token).subscribe(function (results) {
            console.log(results);
        ...
        var _loop_1 = function (droppedFile) {
            ...
            if (droppedFile.fileEntry.isFile) {
                ...
                fileEntry.file(function (file) {
                    ...
                    _this.apiService.sendForm(_this.auth.token, formData)
...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.editAccount = function (token, user) {
        var urlEdit;
        console.log(user);
        urlEdit = __WEBPACK_IMPORTED_MODULE_2__environments_environment__["a" /* environment */].app_url + '/account/edit?token=' + token;
    ...
    ApiService.prototype.getUserMusic = function (token) {
        var urlMusic;
        urlMusic = __WEBPACK_IMPORTED_MODULE_2__environments_environment__["a" /* environment */].app_url + '/music/user?token=' + token;
        return this.http.get(urlMusic);
    };
    ApiService.prototype.sendRequest = function (url, method) {
        var urlSounds;
        urlSounds = __WEBPACK_IMPORTED_MODULE_2__environments_environment__["a" /* environment */].app_url + url;
        return this.http[method](urlSounds);
    };
    ApiService.prototype.sendForm = function (token, formData) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["c" /* HttpHeaders */]({
            'token': token
        });
        return this.http.post(__WEBPACK_IMPORTED_MODULE_2__environments_environment__["a" /* environment */].app_url + '/sound/upload', formData, { headers: headers });
    };
